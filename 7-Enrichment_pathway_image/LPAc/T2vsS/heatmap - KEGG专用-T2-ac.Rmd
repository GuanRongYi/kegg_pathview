...
#Ac-T2
```{r}
kegg_maps<-c("mmu00010","mmu00020","mmu00071","mmu00120","mmu00190","mmu00280","mmu00310","mmu00330","mmu00380","mmu00500","mmu00620","mmu04723","mmu04932","mmu04975","mmu05208","mmu05410","mmu05414","mmu05415")
```
#Ac-T2-大图
```{r}
kegg_maps<-c("mmu00071","mmu00190","mmu00280","mmu04932","mmu05208","mmu05415")
```
...
```{r}
data <-read.xlsx("E:/R/Ac_T2_S -no myh7.xlsx",sep=',')#读取数据
...
#乙酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPAc_7-Enrichment_pathway_image\\T2vsS\\heatmap2"
data<-data2
