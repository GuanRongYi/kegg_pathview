...
#Ac-T8
```{r}
kegg_maps<-c("mmu00010","mmu00020","mmu00062","mmu00071","mmu00190","mmu00250","mmu00270","mmu00280","mmu00310","mmu00330","mmu00380","mmu00470","mmu00620","mmu00630","mmu00640","mmu00650","mmu03018","mmu04022","mmu04146","mmu04714","mmu04723","mmu04932","mmu05010","mmu05012","mmu05014","mmu05016","mmu05020","mmu05022","mmu05208","mmu05415")
```
#Ac-T8-大图
```{r}
kegg_maps<-c("mmu00020","mmu00071","mmu00190","mmu00280","mmu00620","mmu00640","mmu04714","mmu04932","mmu05010","mmu05012","mmu05014","mmu05016","mmu05020","mmu05022","mmu05208","mmu05415")
```

#Ac-T8-超大图
```{r}
kegg_maps<-c("mmu00190","mmu04714","mmu05010","mmu05012","mmu05014","mmu05016","mmu05020","mmu05022","mmu05208","mmu05415")
```
...
```{r}
data <-read.xlsx("E:/R/Ac_T8_S -no myh7.xlsx",sep=',')#读取数据
...
#乙酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPAc_7-Enrichment_pathway_image\\T8vsS\\heatmap2"
data<-data2
...
png(paste0(save_folder,"/",kegg_map,"_heatmap.png"),width=3500,height=9000,res=1200)
#存储为png格式,分辨率
print(p)
dev.off()
}
