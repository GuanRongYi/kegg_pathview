...
#Cr-T8-大图
```{r}
kegg_maps<-c("mmu00010","mmu00020","mmu00052","mmu00071","mmu00190","mmu00270","mmu00280","mmu00330","mmu00500","mmu00620","mmu00630","mmu00640","mmu03018","mmu04066","mmu04146","mmu04217","mmu04260","mmu04670","mmu04714","mmu04723","mmu04918","mmu04919","mmu04922","mmu04932","mmu05010","mmu05012","mmu05016","mmu05020","mmu05022","mmu05208","mmu05230","mmu05410","mmu05412","mmu05414","mmu05415")
```
...
```{r}
data <-read.xlsx("E:/R/Cr_S_T8 - no myh7.xlsx",sep=',')#读取数据
...
#巴豆酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPCr_7-Enrichment_pathway_image\\T8vsS\\heatmap2"
data<-data2
...
png(paste0(save_folder,"/",kegg_map,"_heatmap.png"),width=3500,height=36000,res=1200)
#存储为png格式,分辨率
print(p)
dev.off()
}
