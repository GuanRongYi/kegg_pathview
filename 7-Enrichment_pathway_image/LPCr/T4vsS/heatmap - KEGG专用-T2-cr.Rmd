...
#Cr-T4-大图
```{r}
kegg_maps<-c("mmu00010","mmu00020","mmu00190","mmu00280","mmu00620","mmu04260","mmu04261","mmu04714","mmu04932","mmu05010","mmu00500","mmu05012","mmu05014","mmu05016","mmu05020","mmu05022","mmu05146","mmu05208","mmu05410","mmu05412","mmu05414","mmu05415","mmu05416")
```
#Cr-T4-最大图
```{r}
kegg_maps<-c("mmu00190","mmu04260","mmu04261","mmu04714","mmu04932","mmu05010","mmu05012","mmu05014","mmu05016","mmu05020","mmu05022","mmu05208","mmu05410","mmu05412","mmu05414","mmu05415","mmu05416")
```
...
```{r}
data <-read.xlsx("E:/R/Cr_S_T4 _no myh7.xlsx",sep=',')#读取数据
...
#巴豆酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPCr_7-Enrichment_pathway_image\\T4vsS\\heatmap-2"
data<-data2
...
png(paste0(save_folder,"/",kegg_map,"_heatmap.png"),width=3500,height=5000,res=1200)
#存储为png格式,分辨率
print(p)
dev.off()
}
