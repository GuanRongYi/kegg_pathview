...
#T2-phos
```{r}
kegg_maps<-c("mmu00020","mmu00620","mmu04020","mmu04260","mmu04261","mmu04540","mmu04964","mmu05410","mmu05412","mmu05414","mmu05415","mmu05416")
```

#T2-phos-大图
```{r}
kegg_maps<-c("mmu05410","mmu05412","mmu05414")
```
...
```{r}
data <-read.xlsx("E:/R/T2_S_Phos -no myh7.xlsx",sep=',')#读取数据
...
#乙酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPST_7-Enrichment_pathway_image\\T2vsS\\heatmap2"
data<-data2
