...
#T4-phos
```{r}
kegg_maps<-c("mmu00010","mmu00052","mmu00190","mmu00500","mmu00620","mmu00790","mmu04020","mmu04022","mmu04024","mmu04141","mmu04145","mmu04218","mmu04260","mmu04261","mmu04270","mmu04520","mmu04611","mmu04612","mmu04657","mmu04670","mmu04713","mmu04714","mmu04720","mmu04730","mmu04742","mmu04810","mmu04911","mmu04912","mmu04916","mmu04918","mmu04919","mmu04921","mmu04922","mmu04925","mmu04929","mmu04930","mmu04934","mmu04960","mmu04961","mmu04962","mmu04970","mmu04972","mmu04974","mmu04978","mmu05010","mmu05012","mmu05016","mmu05017","mmu05020","mmu05022","mmu05132","mmu05170","mmu05216","mmu05226","mmu05230","mmu05410","mmu05412","mmu05414","mmu05415","mmu05416")
```

#T4-phos-大图
```{r}
kegg_maps<-c("mmu04020","mmu04022","mmu04024","mmu04218","mmu04260","mmu04261","mmu04270","mmu04520","mmu04611","mmu04670","mmu04713","mmu04714","mmu04810","mmu04911","mmu04912","mmu04919","mmu04921","mmu04922","mmu04925","mmu04972","mmu05010","mmu05012","mmu05016","mmu05017","mmu05020","mmu05022","mmu05132","mmu05410","mmu05412","mmu05414","mmu05415","mmu05416")
```

#T4-phos-再大图
```{r}
kegg_maps<-c("mmu04020","mmu04022","mmu04024","mmu04260","mmu04261","mmu04919","mmu05010","mmu05012","mmu05016","mmu05020","mmu05022","mmu05410","mmu05412","mmu05414","mmu05415")
```

#T4-phos-超大图
```{r}
kegg_maps<-c("mmu05410","mmu05414")
```
...
```{r}
data <-read.xlsx("E:/R/T4_S_Phos - no myh7.xlsx",sep=',')#读取数据
...
#乙酰化组
```{r}
save_folder<-"C:\\Users\\Administrator\\Desktop\\4. Pathview\\LPST_7-Enrichment_pathway_image\\T4vsS\\heatmap2"
data<-data2
...
png(paste0(save_folder,"/",kegg_map,"_heatmap.png"),width=3500,height=10000,res=1200)
#存储为png格式,分辨率
print(p)
dev.off()
}
